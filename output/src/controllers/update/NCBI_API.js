...
exports.promiseThrottle = new PromiseThrottle({
    requestsPerSecond: 3,
    promiseImplementation: Promise // the Promise library you are using
});
exports.getIdsFromSearch = function (searchString, orphanetID) {
...
exports.getRareDisease_YearFromIds = function (idList, orphanetID) {
    /*
            ...
            parser.parseString(data, function (err, data) {
                ...
                if (data !== undefined && data.eSummaryResult !== undefined) {
                    ...
                    for (let i = 0; i < documentSummaries.length; i++) {
                        ...
                        if (!isNaN(yearString)) {
                            let rareDisease_YearIndex = rareDisease_YearList.findIndex(function (currentValue) { return currentValue.year == yearString; });
...
exports.getNumberPublicationsThatCiteGivingPublications = function (idList) {
    return new Promise((resolve, reject) => {
...
exports.getPublications = function (idList, orphanetID) {
    return new Promise((resolve, reject) => {
...
//# sourceMappingURL=NCBI_API.js.map